                ...
                <ul class="navbar-nav">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                    ...
                                    <a href="{{ route('second', ['auth', 'forgotpw']) }}" class="dropdown-item">Forgot
                                        Password</a>
                            ...
                            <a href="{{ route('second', ['pages', 'contact-list']) }}" class="dropdown-item">Contact
                                List</a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-ui-kit">
                                    ...
                                    <a href="{{ route('second', ['ui', 'avatars']) }}"
                                        class="dropdown-item">Avatars</a>
                                    <a href="{{ route('second', ['ui', 'badges']) }}"
                                        class="dropdown-item">Badges</a>
                                    <a href="{{ route('second', ['ui', 'breadcrumb']) }}"
                                    ...
                                    <a href="{{ route('second', ['ui', 'embed-video']) }}"
                                        class="dropdown-item">Embed Video</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-ui-kit2">
                                    ...
                                    <a href="{{ route('second', ['ui', 'typography']) }}"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-extended-ui">
                                    <a href="{{ route('second', ['extended', 'portlets']) }}"
                                        class="dropdown-item">Portlets</a>
                                    <a href="{{ route('second', ['extended', 'scrollbar']) }}"
                                        class="dropdown-item">Scrollbar</a>
                                    <a href="{{ route('second', ['extended', 'range-slider']) }}"
                                        class="dropdown-item">Range Slider</a>
                                    <a href="{{ route('second', ['extended', 'scrollspy']) }}"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    <a href="{{ route('second', ['charts', 'apex']) }}" class="dropdown-item">Apex
                                        Charts</a>
                                    <a href="{{ route('second', ['charts', 'chartjs']) }}"
                                        class="dropdown-item">Chartjs</a>
                                    <a href="{{ route('second', ['charts', 'sparklines']) }}"
                                        class="dropdown-item">Sparkline Charts</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-tables">
                                    <a href="{{ route('second', ['tables', 'basic']) }}" class="dropdown-item">Basic
                                        Tables</a>
                                    <a href="{{ route('second', ['tables', 'datatable']) }}"
                                        class="dropdown-item">Data Tables</a>
                                    <a href="{{ route('second', ['tables', 'editable']) }}"
                                        class="dropdown-item">Editable Tables</a>
                                    <a href="{{ route('second', ['tables', 'responsive']) }}"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    <a href="{{ route('second', ['icons', 'remixicons']) }}"
                                        class="dropdown-item">Remix Icons</a>
                                    <a href="{{ route('second', ['icons', 'bootstrap']) }}"
                                        class="dropdown-item">Bootstrap Icons</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                            ...
                            <a href="{{ route('second', ['layouts-eg', 'light-sidebar']) }}" class="dropdown-item"
                                target="_blank">Light Sidebar</a>
                            <a href="{{ route('second', ['layouts-eg', 'sm-sidebar']) }}" class="dropdown-item"
                                target="_blank">Small Sidebar</a>
                            <a href="{{ route('second', ['layouts-eg', 'collapsed-sidebar']) }}"
                                class="dropdown-item" target="_blank">Collapsed Sidebar</a>
                            <a href="{{ route('second', ['layouts-eg', 'unsticky-layout']) }}" class="dropdown-item"
                                target="_blank">Unsticky Layout</a>
                            <a href="{{ route('second', ['layouts-eg', 'boxed']) }}" class="dropdown-item"
                                target="_blank">Boxed Layout</a>
                        </div>
                    </li>
                </ul>
            </div>
