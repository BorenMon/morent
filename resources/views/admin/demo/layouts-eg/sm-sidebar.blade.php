@extends('admin.layouts.horizontal', ['title' => 'Samll!', 'sidenav' => 'condensed', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('admin.layouts.shared/page-title', ['sub_title' => 'Menu', 'page_title' => 'Samll!'])
