@extends('admin.layouts.horizontal', ['title' => 'Boxed', 'sidenav' => 'condensed', 'layoutMode' => 'boxed', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('admin.layouts.shared/page-title', ['sub_title' => 'Menu', 'page_title' => 'Boxed'])
