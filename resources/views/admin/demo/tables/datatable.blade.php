@extends('admin.layouts.horizontal', ['title' => 'Datatables', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('admin.layouts.shared/page-title', ['page_title' => 'Data Tables', 'sub_title' => 'Tables'])
...
@section('script')
    @vite(['resources/js/admin/demo/datatable.init.js'])
@endsection
