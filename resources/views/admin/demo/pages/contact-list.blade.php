@extends('admin.layouts.horizontal', ['title' => 'Contact List', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('admin.layouts.shared/page-title', ['sub_title' => 'Base UI', 'page_title' => 'Contact List'])
