        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">We only set a <code>height</code> value on the <code>.progress</code>, so if
        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="progress mb-2">
                        <div class="progress-bar bg-purple" role="progressbar" style="width: 85%" aria-valuenow="100"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress mb-2">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code> to
