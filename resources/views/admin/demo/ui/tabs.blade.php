@extends('admin.layouts.horizontal', ['title' => 'Tabs', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('admin.layouts.shared/page-title', ['sub_title' => 'Base UI', 'page_title' => 'Tabs'])
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="profile">
                            ...
                            <p class="mb-0">Food truck quinoa dolor sit amet, consectetuer adipiscing elit. Aenean commodo
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="home1">
                            <p>Leggings occaecat dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget
                                dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur
                                ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla
                                consequat massa quis enim.</p>
                            <p class="mb-0">Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                                    ...
                                    <p class="mb-0">Food truck quinoa dolor sit amet, consectetuer adipiscing elit.
                                        ...
                                        eu, pretium quis, sem. Nulla consequat massa quis enim. Cillum ad ut irure tempor
