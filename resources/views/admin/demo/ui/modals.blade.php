@extends('admin.layouts.horizontal', ['title' => 'Modals', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('admin.layouts.shared/page-title', ['sub_title' => 'Base UI', 'page_title' => 'Modals'])
    <div class="row">
        <div class="col-12">
            <div class="card">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Specify the position for the modal. You can display modal at top, bottom,
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">A rendered modal with header, body and footer having contexual background
                        color.</p>
                </div>
                <div class="card-body">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Display a series of modals one by one to guide your users on multiple
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Another override is the option to pop up a modal that covers the user
                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="exampleModalFullscreenXxl" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-fullscreen-xxl-down">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalFullscreenXxlLabel">Full screen below xxl
                                    </h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">When backdrop is set to static, the modal will not close when clicking
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Have a bunch of buttons that all trigger the same modal with slightly
