@extends('admin.layouts.horizontal', ['title' => 'Tooltips', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('admin.layouts.shared/page-title', ['sub_title' => 'Base UI', 'page_title' => 'Tooltips'])
                ...
                <div class="card-body">
                    <p class="muted mb-0">
                        ...
                        chambray. A really ironic artisan <a href="#" data-bs-toggle="tooltip"
                            ...
                            data-bs-title="The last tip!">twitter handle</a> freegan cred
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted fs-14">We set a custom class with ex.
                        <code>data-bs-custom-class="primary-tooltip"</code> to scope our background-color primary appearance
                        and use
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <button type="button" class="btn btn-purple" data-bs-toggle="tooltip" data-bs-placement="top"
