@extends('admin.layouts.horizontal', ['title' => 'Offcanvas', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('admin.layouts.shared/page-title', ['sub_title' => 'Base UI', 'page_title' => 'Offcanvas'])
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Change the appearance of offcanvases with utilities to better match them to
